...
namespace Microsoft.Data.SqlClient
{
    internal sealed class SqlConnectionString : DbConnectionOptions
    {
        ...
        internal static class DEFAULT
        {
            ...
            internal const bool IsTDSS = DbConnectionStringDefaults.IsTDSS;
        ...
        internal static class KEY
        {
            ...
            internal const string IsTDSS = DbConnectionStringKeywords.IsTDSS;
        ...
        internal SqlConnectionString(string connectionString) : base(connectionString, GetParseSynonyms())
        {
            ...
            _isTDSS = ConvertValueToBoolean(KEY.IsTDSS, DEFAULT.IsTDSS);
            ...
            if (_encrypt == SqlConnectionEncryptionOption.False)
            {    // Support legacy registry encryption settings
                ...
                {         // If the registry key exists
                    _encrypt = SqlConnectionEncryptionOption.True;
                }
            }
        ...
        {
            SqlConnectionEncryptionOption defaultEncryptValue = !Parsetable.ContainsKey(KEY.Authentication) ? DEFAULT.Encrypt : SqlConnectionEncryptionOption.True;
